...
struct CalibrationCommands: public VariableGroup {
  ...
  ScalarPushInput<int32_t> determineTolerance{this, "determineTolerance", "", "Determines tolerance of the end switch positions"};
};
...
struct MotorControl : public VariableGroup {
  ...
  ScalarPushInput<int> enableFullStepping{this, "enableFullStepping", "", "Enables full-stepping mode of the motor driver, i.e., it will only stop on full steps"};
...
struct ReferenceSettings : public VariableGroup {
  ...
  ScalarPushInput<float> position{this, "position", "", "Writing to this value sets the actual motor position to a given reference"};
  ScalarPushInput<int> positionInSteps{this, "positionInSteps", "", "Writing to this value sets the actual motor position to a given reference"};

  ScalarPushInput<int32_t> encoderPosition{this, "encoderPosition", "", "Writing to this value sets the actual encoder position to a given reference"};

  ScalarPushInput<int>   axisTranslationInSteps{this, "axisTranslationInSteps", "steps", "Offset to translate axis, i.e. shift the reference point."};
  ScalarPushInput<float> axisTranslation{this, "axisTranslation", "", "Offset to translate axis, i.e. shift the reference point."};
};
...
struct DummySignals : public VariableGroup {
  ...
  ScalarOutput<int32_t> dummyMotorTrigger{this, "dummyMotorTrigger", "", "Triggers the dummy motor module after writing to a control input"};
...
public:
  ...
  ControlInputHandler(EntityOwner *owner, const std::string &name, const std::string &description, std::shared_ptr<StepperMotor> motor);
